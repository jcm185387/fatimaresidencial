...
<body  class="w3-light-grey">
  <div id="app">
    ...
    <div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
      {{-- <button class="w3-bar-item w3-button w3-hide-large w3-hover-none w3-hover-text-light-grey" onclick="w3_open();"><i class="fa fa-bars"> --}}
        <button class="w3-bar-item w3-button w3-hide-large w3-hover-none w3-hover-text-light-grey" id="w3_open"><i class="fa fa-bars">
      </i>  Menu</button>
    ...
    <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
      <div class="w3-container w3-row">
        <div class="w3-col s4"><!--Esta es la foto de perfil-->
...
{{--         <a href="#" class="w3-bar-item w3-button w3-padding-16 w3-hide-large w3-dark-grey w3-hover-black" onclick="w3_close()" title="close menu"> --}}
      <a href="#" class="w3-bar-item w3-button w3-padding-16 w3-hide-large w3-dark-grey w3-hover-black w3_close"  title="close menu">
      <i class="fa fa-remove fa-fw"></i>  Close Menu</a>
        <a href="{{ url('/DashboardAdmin') }}"  class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-users fa-fw"></i>  General</a>
        <a href="#" class="w3-bar-item w3-button w3-padding"><i class="fa fa-eye fa-fw"></i>  Control de accesos</a>
        <a href="{{ url('/residentes') }}" class="w3-bar-item w3-button w3-padding"><i class="fa fa-users fa-fw"></i>Residentes</a>
        ...
        <a href="#" class="w3-bar-item w3-button w3-padding"><i class="fa fa-money fa-fw"></i>  Finanzas</a>
        ...
        <a href="{{ url('/ConfiguracionColonia') }}" class="w3-bar-item w3-button w3-padding"><i class="fa fa-cog fa-fw"></i>  Configuración de la colonia</a>
...
{{-- <script>
    ...
    function w3_open() {
      if (mySidebar.style.display === 'block') {
        ...
        //mySidebar.style.cssText += ';display:none !important;'
        overlayBg.style.display = "none";
        //overlayBg.style.cssText += ';display:none !important;'
      } else {
        mySidebar.style.display = 'block';
        //mySidebar.style.cssText += ';display:block !important;'
        overlayBg.style.display = "block";
        //overlayBg.style.cssText += ';display:block !important;'
      }
    }
    ...
    function w3_close() {
      mySidebar.style.display = "none !important";
      overlayBg.style.display = "none !important";
    }
</script> --}}
